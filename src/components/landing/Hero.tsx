    ...
    >
      <div className="flex flex-col gap-4 md:gap-6">
        ...
        <div className="flex items-center gap-3 pt-1 md:hidden">
          <Monogram className="size-12 border-2 border-[#FFFDF8] text-[20px]" />
        ...
        <div className="flex items-center gap-3 md:pt-2">
          ...
          <a
            href="#guide"
            className={`hidden h-14 items-center gap-2 rounded-full border-[1.5px] border-[#C9BCA6] px-5.5 text-[17px] font-semibold text-[#1D2A2E] md:flex ${FOCUS_RING}`}
          >
            Voir le guide
          </a>
        </div>
        <div className="hidden items-center gap-3.5 pt-2 md:flex">
          <Monogram className="size-13 border-2 border-[#FFFDF8] text-[22px]" />
      ...
      <div className="relative hidden h-[360px] items-end overflow-hidden rounded-3xl bg-[#CFDCD9] p-5 md:flex lg:h-[460px]">
        {heroPhoto && (
          <>
            <img
              src={`/lieux/${heroPhoto.place.slug}/photo`}
              alt=""
              width={1200}
              height={900}
            ...
            <span className="relative rounded-[14px] bg-[#FFFDF8] px-3 py-1.5 text-[13px] font-semibold text-[#34494C]">
              ...
              {heroPhoto.photo.attribution && ` · Photo : ${heroPhoto.photo.attribution}`}
            </span>
          </>
        )}
      </div>
