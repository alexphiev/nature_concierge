...
export function MobileStickyBar() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex h-[calc(84px+env(safe-area-inset-bottom))] items-center gap-3 border-t border-[#E4DACA] bg-[#FFFDF8] px-4 pt-3 pb-[calc(16px+env(safe-area-inset-bottom))] md:hidden">
